<template>
	<view class="grace-padding">
		<form @submit="formSubmit">
			<view class="target" v-show="userinfoShow">
				<view class="target-list grace-space-between">
					<view class="target-list-title">举报人</view>
			...
			<view class="grace-form">
				<view class="target-info">
					<view class="grace-items">
						<view class="grace-label"><text>举报对象</text><text class="col-red">*</text></view>
						<view class="input-right">{{reportObject}}</view>
					</view>
					<view class="grace-items">
						<view class="grace-label"><text>举报问题类型</text><text class="col-red">*</text></view>
				...
				<view class="target-info">
					...
					<view class="grace-items">
						<view class="grace-label"><text>举报属地(市)</text></view>
					...
					<view class="grace-items grace-noborder">
						<view class="grace-label"><text>举报属地(区)</text></view>
			...
			<view class="pop-detail">
				<view>
					...
					<view class="pop-text">
						...
						<text class="danger">请勿多条重复、虚假举报提交，请慎重对待举报举报通道</text>
					</view>
				</view>
			</view>
		</graceMaskView>
		...
		methods: {
			...
			getComponyInfo:function(){
				_self.$qyc.interfaceRequest(
					...
					function(res) {
						_self.reportObject = res.data.entName;
					}
				);
			},
			//获取污染类型 TODO
