...
<style>
	...
	.col-blue{color:#3691B7 !important;}
	.grace-padding {
		padding: 0;
		width: 100%;
	}
	...
	.text-right{position: absolute;top:0;right:65upx;line-height:100upx;color: #000000;opacity: 0.3;font-size:28upx;}
	.grace-list .grace-list-text {
		opacity: 0.8;
		font-size: 28upx;
		color: #000000;
	}
	.grace-list-imgs-arrow{color: #000000;opacity: 0.5;}
