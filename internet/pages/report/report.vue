	...
	<view class="grace-padding">
		<view class="plaints">
			...
			<view class="plaints-detail" :data='infors'>
				...
				<view class="plaints-text" v-for="(item,index) in infors.matter" :key="index">{{index+1}}.{{item.text}}</view>
			</view>
	...
	export default {
		data() {
			return {
				...
				totalTime: 1,
				infors:{
					area:"国家“互联网+监管”投诉举报系统接收社会公众关于国家“互联网+监管”系统中监管事项清单所有涉及的监管对象的投诉举报，实现互联网在线投诉举报登记和结果反馈。投诉：应是对涉及自身、伤害自身利益的行为进行举证投诉，应包含明确的投诉对象、投诉内容等。举报：应对反映监管对象涉嫌违法违规线索的行为举证举报，可匿名举报。",
				term:[
					{
				...
				matter:[
					{
						text:'投诉举报人应当提供客观真实的投诉举报材料及证据，说明事情的基本经过，提供被投诉举报对象信息，涉嫌违法违规的具体行为，举证相关佐证说明、照片截图等详细信息。'
					},
					{
						text:'提倡实名投诉举报。请您保持电话畅通，以便承办部门及时准确的与您联系，核实相关信息，并反馈办理结果。'
					},
					{
						text:'投诉举报人提供的信息、材料有可能分发转交至相关主管部门处置。'
					},
					{
						text:'投诉举报人应据实进行投诉举报，不得捏造事实、制造假证、诬告陷害他人，应对投诉举报信息的客观性、真实性负责，对查实的故意捏造事实、制造假证、诬告陷害他人的投诉举报人，将进行信息记录，后果严重的，讲按有关规定追究其法律责任。'
					}
				]
				}
			}
