...
.grace-date-header-btn{font-size:38upx; line-height:88upx; padding:0 20px;}
...
.grace-date-time-title{margin-top:30upx; line-height:2em; text-align:center;}
.grace-date-time{width:80%; margin:8px 10%; display:flex; flex-wrap:nowrap;}
.grace-date-time .timer{width:50%;  height:80upx; border-top:1px solid #F0F0F0; border-bottom:1px solid #F0F0F0;}
.grace-date-time .timer picker{width:100%; height:80upx; line-height:80upx; text-align:center;}
.grace-date-time .timer-spliter{width:60upx; flex-shrink:0; text-align:center; line-height:80upx; font-size:40upx;}
.grace-date-btn{width:80%; margin:0 10%; margin-top:40upx; text-align:center; line-height:92upx;}
</style>
